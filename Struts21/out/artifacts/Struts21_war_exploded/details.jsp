...
<div class="a3">
	<div class="a4">
		<ul>
			...
			<li><a href="CartAction.action?che=购物车"><img alt="" src="img/che.jpg"></a></li>
		</ul>
	</div>
</div>
<br>
<div class="a5">
	...
	<div class="a6">
		<div class="a7">
			...
			<div>
				<!-- 大图展示区 -->
				<img alt="" src="${gphoto[1]} " width="430px" height="270px">
				<div class="a8">
					<form action="CartAction.action?sname=${sname}" method="post">
						<table>
							<tr>
